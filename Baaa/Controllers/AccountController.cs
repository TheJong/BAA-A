    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ModelState.AddModelError("", "Login gegevens onjuist!");
                    return View(model);
            }
        }
        ...
        public async Task<ActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            switch (result)
            {
                ...
                case SignInStatus.Failure:
                default:
                    ModelState.AddModelError("", "Foute code.");
                    return View(model);
            }
        }
        ...
        public ActionResult RoleCreate(string roleName)
        {
            ...
            ViewBag.ResultMessage = "Rol is aangemaakt! !";
        ...
        public ActionResult RoleDelete(string roleName)
        {
            ...
            ViewBag.ResultMessage = "Rol is verwijderd!";
            return RedirectToAction("RoleIndex", "Account");
        }
        ...
        public ActionResult RoleAddToUser(string roleName, string userName)
        {
            ...
            using (var context = new ApplicationDbContext())
            {
                ...
                //Check if user has this role, if not add role
                if (userManager.IsInRole(user.Id, role.Name))
                {
                    ViewBag.ResultMessage = "Deze gebruiker heeft deze rol al!";
                }
                else
                {
                    ...
                    ViewBag.ResultMessage = "Rol is toegevoegd!";
                }
        ...
        public ActionResult DeleteRoleForUser(string userName, string roleName)
        {
            ...
            using (var context = new ApplicationDbContext())
            {
                ...
                //check if user has this role and delete it.
                if (userManager.IsInRole(user.Id, roleName))
                {
                    userManager.RemoveFromRole(user.Id, roleName);
                    context.SaveChanges();

                    ViewBag.ResultMessage = "Rol is van deze gebruiker verwijderd!";
                }
                else
                {
                    ViewBag.ResultMessage = "Deze gebruiker heeft deze rol niet!.";
                }
